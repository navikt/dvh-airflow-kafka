...
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/python:3.13.13-dev AS builder
...
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/python:3.13.13
